...
#[actix_web::get("/admin/<domain>/accounts/<user_name>")]
pub async fn admin_domain_account_get(session_ref: actix_web::web::ReqData<Option<Session>>, domain: String, user_name:String) -> Return {
    admin_domain_account_get_impl(&*session_ref, domain, user_name, None).await
}

pub(in crate::rocket) async fn admin_domain_account_get_impl(session: &Option<Session>, domain: String, user_name:String, error: Option<&str>) -> Return {
